...
<head>
  ...
  <style>
    body {
      ...
      background-image: url('homemadebackground.png'); /* Replace with your image URL */
...
<body>
  ...
  <main>
    <div class="grid-container">
      ...
      $sql = "SELECT p.ProductID, p.SellerName, p.ProductName, p.ProductPrice, p.ProductDesc, p.ProductImage, p.ProductVariety, p.Quantity,
