...
<body>
    ...
    if (!isset($_SESSION['BuyerID'])) {
        echo "<div class='alert alert-danger'>You are not logged in. Please log in to register a complaint.</div>";
        exit();
    }

    // Retrieve user's first name from session
    $fname = isset($_SESSION['fname']) ? htmlspecialchars($_SESSION['fname']) : 'Customer';
    ?>
    ...
    <form action="submit_complaint.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" id="customerName" name="customerName" value="<?php echo $fname; ?>" readonly><br>
