        ...
        <div class="profile-container">
            ...
            <div class="profile-details">
                ...
                <?php if (isset($user['fname'])): ?>
                    <p><strong>Welcome,</strong> <?= htmlspecialchars($user['fname']) ?></p>
                <?php endif; ?>
                <?php if (isset($user['email'])): ?>
                    <p><strong></strong> <?= htmlspecialchars($user['email']) ?></p>
                <?php endif; ?>
                <?php if (isset($user['phonenumber'])): ?>
                    <p><strong></strong> <?= htmlspecialchars($user['phonenumber']) ?></p>
                <?php endif; ?>
            </div>
        ...
        <div class="notifications">
            ...
            <ul>
                ...
                if (isset($_SESSION['emailidb'])) {
                    ...
                    if ($buyerID) {
                        // Fetch notifications based on buyerID
                        $sql = "SELECT message FROM notifications WHERE buyerID = ? ORDER BY timestamp DESC";
                        $stmt = $conn->prepare($sql);
                        ...
                        echo "<li>No buyer found for this email.</li>";
                    }

                    $conn->close();
                } else {
                    echo "<li>Please log in to view your notifications.</li>";
                }
                ?>
            </ul>
        </div>
